...
export default {
  ...
  methods:{
    createStars(numStars) {
      const starsContainer = this.$refs.stars;
...
<style src="./assets/css/starry-background.css"></style>
...
// /***** 粉红色主题****/
@tcolors:#fa7fa8;//按钮和标签颜色
@tcolorm:#29f5d3;//分类的选中的颜色
@tcolord:#7affc1;//按钮hover 的颜色
//
// /******淡黄色主题*****/
// @tcolors:#97dffd;//按钮和标签颜色
// @tcolorm:#64609E;//分类的选中的颜色
